...
var App = React.createClass({displayName: "App",
    ...
    render: function () {
        return (
            React.createElement(Page, {url: HOST, full: PAGE != "thanks", info: this.state.info, 
...
},{"./components/page.jsx":174,"react":157}],2:[function(require,module,exports){
    ...
    render: function () {
        var content = this.props.contents.map(function (datum) {
            if (datum.type == 'text-module') {
                return (React.createElement(NodeTextModule, {key: datum.id, node: datum}));
            }
            if (datum.type == 'image-hero-module') {
                return (React.createElement(ImageHeroModule, {key: datum.id, node: datum}));
            }
            if (datum.type == 'image-body-module') {
                return (React.createElement(ImageBodyModule, {key: datum.id, node: datum}));
            }
            if (datum.type == 'work-overview') {
                return (React.createElement(OverviewModule, {key: datum.id, node: datum}));
            }
            return '';
        });
        return (
...
},{"./node--type_image-body-module.jsx":167,"./node--type_image-hero-module.jsx":168,"./node--type_text-module.jsx":170,"./node--type_work-overview.jsx":172,"react":157}],161:[function(require,module,exports){
var React = require('react');

var ModuleContact = React.createClass({displayName: "ModuleContact",
    ...
    renderInput: function (ele, cssClass, placeHolder, ref) {
        var input;
        if (ele == 'textarea') {
            input = React.createElement("textarea", {rows: "1", className: "contact__textarea", placeholder: placeHolder, name: ref, ref: ref});
        } else {
            input = React.createElement("input", {type: "text", className: "contact__input", placeholder: placeHolder, name: ref, ref: ref});
        }
        return (
            React.createElement("div", {className: "contact__item"}, 
                React.createElement("div", {className: "contact__icon-wrapper"}, 
                    React.createElement("div", {className: 'contact__icon ' + cssClass})
                ), 
                input
            )
            );
    ...
    render: function () {
        return (React.createElement("section", {className: "contact"}, 
            React.createElement("div", {className: "contact__border-wrapper"}, 
                React.createElement("div", {className: "contact__border"})
            ), 

            React.createElement("div", {className: "contact__wrapper"}, 
                React.createElement("div", {className: "contact__left"}, 
                    React.createElement("h2", null, "Let's talk"), 
                    React.createElement("div", {className: "contact__left-text"}, 
                    "Every moment offers the opportunity to discover and create something new. Let's make something great together."
                    ), 
                    React.createElement("div", {className: "contact__left-contact"}, 
                    this.props.info.phone1, 
                        React.createElement("br", null), this.props.info.email
                    )
                ), 
                React.createElement("div", {className: "contact__right"}, 
                    React.createElement("form", {onSubmit: this.handleSubmit, action: this.props.url + "/doContact", method: "POST"}, 
                        ...
                        React.createElement("div", {className: "contact__submit-wrapper"}, 
                            React.createElement("input", {type: "submit", className: "btn btn-primary", value: "Send"})
                        )
                    )
                )
            )
...
var FieldLink = React.createClass({displayName: "FieldLink",
    render: function () {
        return (
            React.createElement("a", {className: "btn btn-default", href: this.props.url, onClick:  this.props._click}, 
             this.props.text
            ));
    }
});
...
var FieldText = React.createClass({displayName: "FieldText",
    render: function () {
        if (!this.props.breakOnLine) {
            return React.createElement("span", {dangerouslySetInnerHTML: {__html: format(this.props.data)}});
        }
        else {
            var lines = (this.props.data || '').replace(/^\s+|\s+$/, '').split(/\s*\n\s*/);
            return React.createElement("div", {className: "field--text-lines"}, 
				
                    lines.map(function (line) {
                        return React.createElement("div", {className: "field--text-line", key: line.id}, 
                            React.createElement("span", {dangerouslySetInnerHTML: {__html: format(line)}})
                        );
                    })
...
},{"../../commons/format":158,"react":157}],164:[function(require,module,exports){
var React = require('react');
...
var Footer = React.createClass({displayName: "Footer",
    render: function () {
        ...
        return (React.createElement("footer", {className: "footer"}, 
            ...
            "© ", info ? info.since : "", " - ", year, " ", info ? info.fullName : "", 
    ...
    render: function () {
        ...
        var items = [
            React.createElement("li", {key: "home"}, 
                React.createElement("a", {href: this.props.url}, "Home")
            ),
            React.createElement("li", {key: "work"}, 
                React.createElement("a", {href: this.props.url + "/work"}, "Work")
            ),
            React.createElement("li", {key: "about"}, 
                React.createElement("a", {href: this.props.url + "/about"}, "About")
            ),
            /*<li><a href="#">Ideas</a></li>,*/
            React.createElement("li", {key: "contact"}, 
                React.createElement("a", {onClick: this._onClick}, "Contact")
            )
        ];
        return (
            React.createElement("header", {className: "header"}, 
                React.createElement("nav", {className: "navbar"}, 
                    React.createElement("div", {className: "navbar-header"}, 
                        React.createElement("a", {className:  "navbar-toggle " + (this.state.collapsed ? "collapsed" : ""), onClick:  this._toggle}, 
                        ...
                        React.createElement("a", {className: "brand", href: "/"}, 
                            React.createElement("img", {alt: info ? info.name : "", src: "/images/logo.png"})
                        )
                    ), 
...
},{"../../controllers/animate":159,"react":157}],166:[function(require,module,exports){
var React = require('react');
...
var ImageModule = function (scrollBehavior) {
    return {
        ...
        _button: function (i, click) {
            ...
            if (link && link.text) {
                return (
                    React.createElement("div", {className:  "module-image" + i + "__button-container"}, 
                        React.createElement(FieldLink, {url: this.props.node.link.url, _click: click ? click : null, 
...
},{"./field--field_link.jsx":162,"react":157}],167:[function(require,module,exports){
var React = require('react');
var FieldText = require('./field--field_text.jsx');

var NodeImageBody = React.createClass({displayName: "NodeImageBody",
    mixins: [ require('./image-module.jsx')() ],
    render: function () {
        return (
            React.createElement("section", {ref: "section", className: "module-image2", style:  this._style() }, 
                React.createElement("div", {className: "module-image2__border-wrapper"}, 
                    React.createElement("div", {className: "module-image2__border"})
                ), 

                React.createElement("div", {className: "module-image2__text-container1"}, 
                    React.createElement("div", {className: "module-image2__text-container2"}, 
                        React.createElement("h2", {className: "module-image2__title"}, 
                            React.createElement(FieldText, {data: this.props.node.title})
                        ), 
                        React.createElement("div", {className: "module-image2__text"}, 
                            React.createElement("div", {className: "module-image2__text-inner"}, 
                                React.createElement(FieldText, {data: this.props.node.text})
                            ), 
						 this._button(2) 
                        )
                    )
...
},{"./field--field_text.jsx":163,"./image-module.jsx":166,"react":157}],168:[function(require,module,exports){
var React = require('react'),
    animate = require('../../controllers/animate');
var FieldText = require('./field--field_text.jsx');
var FieldLink = require('./field--field_link.jsx');

var NodeImageHero = React.createClass({displayName: "NodeImageHero",
    ...
    render: function () {
        ...
        return (
            React.createElement("section", {ref: "section", className:  "module-image1" +
                (hasButton ? '' : ' module-image1--nobutton') +
                (this.props.node.id == 'home-1' ? ' section-home-hero' : ''), 
            style:  this._style() }, 
                React.createElement("h2", {className: "module-image1__text"}, 
                    React.createElement(FieldText, {breakOnLine: true, data: this.props.node.title})
                ), 
...
},{"../../controllers/animate":159,"./field--field_link.jsx":162,"./field--field_text.jsx":163,"./image-module.jsx":166,"react":157}],169:[function(require,module,exports){
var React = require('react');
var FieldText = require('./field--field_text.jsx');

var NodeLine = React.createClass({displayName: "NodeLine",
    render: function () {
        return (
            React.createElement("div", {className:  "module-text__text" }, 
                React.createElement("h2", {className: "module-text__title"}, 
                    React.createElement(FieldText, {key:  this.props.node.title, data:  this.props.node.title})
                ), 
                React.createElement("div", {className:  "module-text__text-inner module-text__text--" + this.props.node.size}, 
                    React.createElement(FieldText, {key:  this.props.node.text, data:  this.props.node.text})
                )
            ));
    }
});
...
},{"./field--field_text.jsx":163,"react":157}],170:[function(require,module,exports){
var React = require('react');
var NodeLine = require('./node--type_line.jsx');

var NodeTextModule = React.createClass({displayName: "NodeTextModule",
    render: function () {
        var content = this.props.node.lines.map(function (line) {
            return (React.createElement(NodeLine, {key: line.id, node: line}));
        });
        return (
            React.createElement("section", {className: "module-text"}, 
                React.createElement("div", {className: "module-text__border-wrapper"}, 
                    React.createElement("div", {className: "module-text__border"})
                ), 

                React.createElement("div", {className: "module-text__container"}, 
				    content
                )
            )
            );
...
},{"./node--type_line.jsx":169,"react":157}],171:[function(require,module,exports){
var React = require('react'),
    NodeWorkPageOverview = require('./node--type_work-page--context_overview.jsx');

var NodePage = React.createClass({displayName: "NodePage",
    render: function () {
        ...
        if (itemNodes.length) {
            ...
            items.push(React.createElement("a", {href:  '/work/' + item.id, className: "work-category--item-first"}, 
                React.createElement(NodeWorkPageOverview, {node: item})
            ));
        }
        while (itemNodes.length) {
            if (itemNodes.length == 1) {
                var item = itemNodes.shift();
                items.push(React.createElement("div", {className: "work-category--items"}, 
                    React.createElement("a", {href:  '/work/' + item.id, className: "work-category--item-left"}, 
                        React.createElement(NodeWorkPageOverview, {key: item.id, node: item})
                    ), 
                    React.createElement("div", {className: "work-category--item-right-empty"})
                ));
            }
            else {
                var item1 = itemNodes.shift(), item2 = itemNodes.shift();
                items.push(React.createElement("div", {className: "work-category--items"}, 
                    React.createElement("a", {href:  '/work/' + item1.id, className: "work-category--item-left"}, 
                        React.createElement(NodeWorkPageOverview, {key: item1.id, node: item1})
                    ), 
                    React.createElement("a", {href:  '/work/' + item2.id, className: "work-category--item-right"}, 
                        React.createElement(NodeWorkPageOverview, {key: item2.id, node: item2})
                    )
                ));
            }
        }
        return (
            React.createElement("div", {className: "work-category"}, 
                React.createElement("div", {className: "work-category--name"},  this.props.node.name), 
			 items 
            ));
    }
});
...
},{"./node--type_work-page--context_overview.jsx":173,"react":157}],172:[function(require,module,exports){
var React = require('react'),
    animate = require('../../controllers/animate'),
    NodeWorkCategory = require('./node--type_work-category.jsx');

var NodeWorkOverview = React.createClass({displayName: "NodeWorkOverview",
    ...
    render: function () {
        ...
        var cats = categories.map(function (category) {
            return (
                React.createElement("li", {className: "work-overview--category"}, 
                    React.createElement("a", {key:  category.id, onClick:  self._select.bind(self, category.id) }, 
					 category.name
                    )
                ));
        });
        var items = categories.map(function (category) {
            return React.createElement(NodeWorkCategory, {key:  category.id, ref: 'category-' + category.id, node:  category });
        });
        return React.createElement("div", null, 
            React.createElement("div", {className: "work-overview--categories"}, 
                React.createElement("ul", null,  cats )
            ), 
			 items 
        );
    }
...
},{"../../controllers/animate":159,"./node--type_work-category.jsx":171,"react":157}],173:[function(require,module,exports){
var React = require('react');

var NodeWorkPageOverview = React.createClass({displayName: "NodeWorkPageOverview",
    render: function () {
        var s = {};
        ...
        return (
            React.createElement("div", {className: "work-category--item", style:  s }, 
                React.createElement("div", {className: "work-category--item-name"},  this.props.node.name), 
                React.createElement("div", {className: "work-category--item-subname"},  this.props.node.subName)
            ));
    }
});
...
var Page = React.createClass({displayName: "Page",
    render: function () {
        var contact = "";
        if (this.props.full) {
            contact = React.createElement(ContactForm, {info: this.props.info, url: this.props.url});
        }
        return (
            React.createElement("div", null, 
                React.createElement(Header, {info: this.props.info, url: this.props.url}), 
                React.createElement(Body, {contents: this.props.contents, overviews: this.props.overviews}), 
                contact, 
                React.createElement(Footer, {info: this.props.info})
            ));
    }
});
...
},{"./body.jsx":160,"./contact-form.jsx":161,"./footer.jsx":164,"./header.jsx":165,"react":157}]},{},[1]);
